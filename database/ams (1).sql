...
(1, 4, 'machinery', 9495471373, 7412589630, 11, 3300, 'Babu', 'vellu', 'Cheyyar', 'Tamilnadu', 604407, 9747052235, 'Order Delivered', '2021-03-13 13:46:43'),
(2, 8, 'fertilizer', 9495471373, 7412589630, 10, 500, 'dilli', 'pannieer', 'Cheyyar', 'Tamilnadu', 604407, 9747052235, 'Order Shipped', '2021-03-13 13:49:12'),
(3, 2, 'crop', 9495471373, 9747052235, 15, 2985, 'babu', 'Vellu', 'Arcot', 'Tamilnadu', 604407, 9747052235, 'Order Recieved', '2021-03-13 13:12:18'),
(4, 5, 'machinery', 9747052235, 7412589630, 10, 2500, 'babu', 'vellu', 'Kancheepuram', 'Tamilnadu', 631502, 9526174577, 'waiting for order confirmation', '2021-03-13 10:28:00'),
(5, 8, 'fertilizer', 9747052235, 7412589630, 15, 750, 'babu', 'Ramasamy', 'Kancheepuram', 'Tamilnadu', 631502, 9526174577, 'waiting for order confirmation', '2021-03-13 10:29:27');
...
('Natarajan', 'B', 'seller', 9578878825, 'natrajan19may@gmail.com', '123456', 'approved'),
('Dulquer', 'Salman', 'user', 8597461233, 'dqsalmaan@gmail.com', 'dqSalmaan', 'pending'),
('Ravichandar', 'O', 'seller', 6385358587, 'ravichandar@gmail.com', 'Ravi@123', 'pending'),
('Subash', 'S', 'farmer', 6369963217, 'subash@gmail.com', 'Subash@123', 'pending'),
('Dhayanithi', 'P', 'labourer', 6382995806, 'dhayanithi@gmail.com', 'Dhayanithi@123', 'pending'),
...
('Prabha', 'Karan', 'labourer',6384347174, 'prabha@gmail.com', '123456', 'approved'),
('santhosh''', 'E', 'admin', 9786011613, 'santhosh2012@gmail.com', 'Sant@429', 'approved'),
('Elumalai', 'M', 'farmer', 7373128432, 'Elumalai@gmail.com', '123456', 'approved'),
('jayaprakash', 'p', 'user', 6383521297, 'jayaprakash@gmail.com', '123456', 'approved'),
('Dhatchan', 'S', 'seller', 7339496114, 'Dhatchankumar@gmail.com', '123456', 'approved');
